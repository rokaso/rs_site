...
## Ambience
Next morning we went over some details, team confirmation if all is well and started working. I started from the ambience, as this is a great way to start the whole story telling of the world. The ambience is set to the place whether there is someone there or not. It is what makes the mood of the place, it is the setting of it all, the base. From it you can build other sounds that can supplement the environment mood. It is good for a couple of reasons, it help you build new sounds and second, while listening to it over time you can hear if the made ambience is annoying or not, does it sit unconsciously in the background or is it to much in the face.
...
These are the two samples used for making the ambience a 3 second low wind drone and a one shot water drop. Hooked it up in FMOD, made the water drop to have a 33% chance of being called so that it wouldn't be called every single time.
